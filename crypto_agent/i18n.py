...
T: dict[str, dict[str, str]] = {
    ...
    "kind_cloud_below": {AR: "تحت سحابة Ichimoku", EN: "below the Ichimoku cloud"},
    "kind_cloud_inside": {AR: "داخل سحابة Ichimoku", EN: "inside the Ichimoku cloud"},
    "kind_bearish": {AR: "اتجاه هابط (سبوت — مفيش شورت)", EN: "bearish trend (spot — no short)"},
    "kind_sideways": {AR: "عرضي — الإشارات مش متفقة", EN: "sideways — signals disagree"},
    "kind_cost": {AR: "الستوب ضيق — التكاليف بتاكله", EN: "stop too tight — costs eat it"},
    "kind_too_extended": {AR: "السعر بعيد عن أقرب دعم", EN: "price too far from support"},
    "kind_low_rr": {AR: "R:R أقل من الحد بعد التكاليف", EN: "R:R below the minimum after costs"},
    "kind_no_support": {AR: "مفيش دعم واضح تحت السعر", EN: "no clear support below price"},
    "kind_no_resistance": {AR: "مفيش مقاومة واضحة فوق السعر", EN: "no clear resistance above price"},
    "kind_no_atr": {AR: "شموع غير كافية لحساب ATR", EN: "not enough bars for ATR"},
    "kind_bad_stop": {AR: "الستوب فوق الدخول", EN: "stop above entry"},
    "kind_low_confidence": {AR: "إعداد صالح بثقة تحت الحد", EN: "valid setup, confidence below threshold"},
    "kind_other": {AR: "بدون إشارة واضحة", EN: "no clear signal"},
    "more_opportunities": {
        AR: "و{n} فرصة أخرى تحت حد العرض.",
